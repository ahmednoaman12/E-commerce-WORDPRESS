                    ...
                    <div class="attr-panel-body">
                        ...
                        <div class="ekit-admin-accordion-btn-group">
                            <?php if( did_action('elementskit/loaded') ): ?>
                                <a class="ekit-admin-access-token cache_clean_social_provider ekit-admin-accordion-btn" data-provider="fb_page_feed" data-url_part="fb-feed">
            ...
            <div class="attr-panel ekit_accordion_card">
                ...
                <div id="fbp_review_control_data" class="attr-panel-collapse attr-collapse" role="tabpanel"
                    ...
                    <div class="attr-panel-body">
                        ...
                        <div class="ekit-admin-accordion-btn-group">
                            <?php if ( did_action('elementskit/loaded') ): ?>
                                <a class="ekit-admin-access-token cache_clean_social_provider ekit-admin-accordion-btn" data-provider="fb_page_reviews" data-url_part="fb-pg-review">
                                    <?php echo esc_html__('Clear Cache', 'elementskit-lite') ?>
                                </a>
                            <?php endif; ?>

                            <a class="ekit-admin-access-token ekit-admin-accordion-btn" href="https://token.wpmet.com/social_token.php?provider=facebook&_for=page<?php echo $dbg ?>" target="_blank">
                                <?php echo $btn ?>
                            </a>
                        </div>
                    </div>
            ...
            <div class="attr-panel ekit_accordion_card">
                ...
                <div id="dribble_control_data" class="attr-panel-collapse attr-collapse" role="tabpanel"
                    ...
                    <div class="attr-panel-body">
						...
						?>
                        <div><?php echo __('Please add below redirect in your app settings', 'elementskit-lite') ?> <a
                                    href="https://i.imgur.com/mtOlSif.png"
                                    target="_blank"><?php esc_html_e('how?', 'elementskit-lite') ?></a></div>
                        ...
                        <div class="ekit-admin-accordion-btn-group">
                            <?php if ( empty($user_data['dribble']['access_token']) ): ?>
                                <a style="cursor: pointer" class="ekit-admin-access-token ekit-admin-accordion-btn"
                                data-rest="<?php echo get_rest_url(); ?>"
                                data-nonce="<?php echo wp_create_nonce('wp_rest'); ?>" id="dribble_access_btn" href="#"
                                target="_blank"> <?php echo esc_html__('Get Access Token', 'elementskit-lite'); ?> </a>
                            <?php else: ?>
                                <a style="cursor: pointer" class="ekit-admin-access-token ekit-admin-accordion-btn"
                                data-rest="<?php echo get_rest_url(); ?>"
                                data-nonce="<?php echo wp_create_nonce('wp_rest'); ?>" id="dribble_access_btn" href="#"
                                target="_blank"> <?php echo esc_html__('Refresh Access Token', 'elementskit-lite'); ?> </a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="attr-panel ekit_accordion_card">
                ...
                <div id="twitter_data_control" class="attr-panel-collapse attr-collapse" role="tabpanel"
                    ...
                    <div class="attr-panel-body">
                        ...
                        <div class="ekit-admin-accordion-btn-group">
                            <a class="ekit-admin-access-token ekit-admin-accordion-btn" href="https://token.wpmet.com/index.php?provider=twitter" target="_blank">
            ...
            <div class="attr-panel ekit_accordion_card">
                ...
                <div id="instagram_data_control" class="attr-panel-collapse attr-collapse" role="tabpanel"
                    ...
                    <div class="attr-panel-body">
                        ...
                        <div class="ekit-admin-accordion-btn-group">
                            <?php if ( did_action('elementskit/loaded') ): ?>
                                <a class="ekit-admin-access-token cache_clean_social_provider ekit-admin-accordion-btn" data-provider="instagram_feed" data-url_part="instagram-feed">
                                    <?php echo esc_html__('Clear Cache', 'elementskit-lite') ?>
                                </a>
                            <?php endif; ?>

                            <a href="https://token.wpmet.com/social_token.php?provider=instagram" class="ekit-admin-access-token ekit-admin-accordion-btn" target="_blank">
                                <?php echo esc_html__('Get access token', 'elementskit-lite'); ?>
                            </a>
                        </div>
                    </div>
            ...
            <div class="attr-panel ekit_accordion_card">
                ...
                <div id="zoom_data_control" class="attr-panel-collapse attr-collapse" role="tabpanel"
                    ...
                    <div class="attr-panel-body">
						...
						?>
                        <div class="ekit-admin-accordion-btn-group">
                            <a href="https://token.wpmet.com/index.php?provider=zoom" class="ekit-admin-access-token ekit-zoom-connection ekit-admin-accordion-btn" target="_blank">
