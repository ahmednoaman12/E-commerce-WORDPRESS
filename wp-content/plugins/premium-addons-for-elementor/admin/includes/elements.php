...
$elements = array(
	...
	'cat-6'  => array(
		...
		'elements' => array(
			...
			// 'demo'     => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/', 'settings-page', 'wp-dash', 'dashboard' ),
			// 'doc'      => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs-category/using-widgets/', 'settings-page', 'wp-dash', 'dashboard' ),
			// 'tutorial' => '',
			// 'is_pro'   => true,
			// ),
		),
